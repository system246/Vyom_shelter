...
import {
  Search, Building2, Key, ShieldCheck, UserPlus, BadgeCheck, Home as HomeIcon,
  Sparkles, Store, Warehouse, Users, MapPin, Quote, Plus, X, Star,
} from 'lucide-react';
...
const TICKER = [
  { icon: 'BadgeCheck', text: '100% Verified Listings' },
  { icon: 'ShieldCheck', text: 'Trusted Property Broker' },
  { icon: 'UserCheck', text: 'No Login for Buyers & Sellers' },
  { icon: 'MapPinned', text: 'Pan-India Coverage' },
  { icon: 'Car', text: 'Site Visit Assistance' },
...
export default function Home() {
    ...
    '@graph': [
      {
        ...
        name: 'Vyom Shelter Pvt. Ltd.',
        url: SITE_URL,
        image: `${SITE_URL}/VSicon.png`,
        description: 'Verified property broker — buy, sell and rent properties across India with trusted associates.',
        areaServed: 'IN',
      },
      {
        '@type': 'WebSite',
  ...
  return (
    <div className="relative">
      <Seo
        description="Buy, sell or rent verified properties across India with Vyom Shelter — a trusted property broker. Plots, flats, houses, commercial shops and farm houses, no login required to browse."
        path="/"
        jsonLd={homeJsonLd}
      />
      ...
      {/* Why Vyom Shelter — own tinted section */}
      ...
      <div className="max-w-5xl mx-auto px-4 pb-14">
        <Reveal className="card p-8 bg-gradient-to-r from-[#fff7ed] to-[#ffeede] border-orange-100 flex flex-col sm:flex-row items-center justify-between gap-5">
          ...
          <div className="flex items-center gap-3 flex-shrink-0">
            ...
            <Link to="/login" className="btn-accent text-base px-6 py-3 rounded-xl">
      ...
      <div className="fixed bottom-6 right-6 z-40">
        {fabOpen && (
          <div className="mb-3 flex flex-col gap-2 items-end animate-[fadeIn_0.2s_ease-out]">
