...
import {
  submitAssociate, getAllAssociates, getAssociateById,
  updateStatus, deleteAssociate, lookupByRefNo,
} from '../controllers/associate.controller.js';

const router = express.Router();

router.get('/lookup',          protect, allow('head_admin', 'admin', 'associate'), lookupByRefNo);
...
router.patch('/:id/status',    protect, allow('head_admin', 'admin'), updateStatus);
